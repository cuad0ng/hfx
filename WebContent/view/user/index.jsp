...
<head>
<title>HFX</title>
<base href="${pageContext.request.contextPath}/view/user/">
<meta charset="UTF-8">
		...
		<div class="container">
				...
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<c:forEach var="category" items="${listCategory}">
						<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
							data-filter=".<c:out value='${category.code}' />">
			...
			<div class="row isotope-grid">
				...
				<c:forEach var="product" items="${listProduct}">
					...
					<div
						class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <c:out value='${product.category_code}' />">

						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="<c:out value='${product.image}' />" alt="IMG-PRODUCT">
